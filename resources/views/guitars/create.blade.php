...
<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
    ...
    <form class="form bg-white p-6 border-1" method="POST" action="{{ route('guitars.store') }}">
        ...
        <div>
            ...
            <input class="text-lg border-1" type="text" id="name" value="{{ old('guitar-name') }}" name="name">
            @error('guitar-name')
        ...
        <div>
            ...
            <input class="text-lg border-1" type="text" id="year_made" value="{{ old('year') }}" name="year_made">
            @error('year')
                <div class="form-error">
                    {{ $message }}
                </div>
